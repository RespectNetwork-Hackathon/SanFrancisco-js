(function (window) {
	...
	xdi = {
			...
			util: {
				...
				getNodeType: function(subsegment) {

					if (! (subsegment instanceof Subsegment)) subsegment = xdi.parser.parseSubsegment(subsegment);

					if (subsegment._string === xdi.constants.xri_root) {
					
						return "root";
					} else if (subsegment._xref &&
						subsegment._xref._xs === xdi.constants.xs_root) {
					
						return "root";
					} else if (subsegment._cs === xdi.constants.cs_value) {
					
						return "value";
					}
				
					alert(subsegment._cs);
					alert(subsegment._xref._xs);
